...
public class DccArgDeclarationListImpl extends ASTWrapperPsiElement implements DccArgDeclarationList {

  public DccArgDeclarationListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DccArgDeclaration> getArgDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DccArgDeclaration.class);
  }
