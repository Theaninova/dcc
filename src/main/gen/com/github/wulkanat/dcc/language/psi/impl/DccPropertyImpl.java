...
public class DccPropertyImpl extends ASTWrapperPsiElement implements DccProperty {

  public DccPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public String getKey() {
    return DccPsiImplUtil.getKey(this);
  }

  @Override
  @Nullable
  public String getValue() {
    return DccPsiImplUtil.getValue(this);
  }
